...
sudo service unicorn_perks_factory <start|stop|restart>
sudo service sidekiq_perks_factory <start|stop>
```
...
```
/home/deployer/apps/perks_factory/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_perks_factory restart
sudo service sidekiq_perks_factory stop
sudo service sidekiq_perks_factory start
```
